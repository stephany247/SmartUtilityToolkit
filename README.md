...
A clean, scalable mobile utility app built with React Native and Expo. Currently ships with a fully functional **Unit Converter** — architected from the ground up to grow into a complete toolkit.
...
└── src/
    ├── screens/
    │   └── ConverterScreen.tsx      # Main screen, all converter state
    ├── components/
    │   ├── CategoryPill.tsx         # Horizontal category selector
    │   ├── ConvertField.tsx         # Input card with unit selector button
    │   ├── UnitPicker.tsx           # Drag-to-close bottom sheet modal
